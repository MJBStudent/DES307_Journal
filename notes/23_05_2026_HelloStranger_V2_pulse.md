...
Continuing on 5.7 does have risk (can't troubleshoot on the spot) 
However I might ask Dr Toby Gifford about the possibility of upgrading the engine RE: Cave2 , certainly in an ideal world the package works quite well and is the only thing needed to execute.

Since the OSC reciever worked, I began thinking more about the environment and essentialy the design brief, what am I trying to achieve, why is this interesting for the Cave2, is it flexible, who is my audience.

The last is an interesting one, the more I look into anxiety and listen to podcasts on the matter it is a suprisingly isolating thing given how prevelant it is and does not discriminate accross any level of society or walk of life. 

Much of this is to say my audience is anyone who can emphathise and perhaps connect to similar feelings or experiences hopefully it is interesting enough of an experience to solicite some excitment - I'm not really interested in a dramatic peice about its sadness, but rather perhaps recognizing similar language someone else with anxiety might recognize it and connect, is that enough to spark even cursory conversations about anxiety would have been a great benifit to me growing up. Visual manifestations of invisible things, though it is strange at how unatural our life is on this planet given our very short occupancy of it.
...
Doing screencapture draw overs are a quick way to try and develop the visual language. Interestingly it has retianed a lot of elements that I thought would be placeholder (pastel purple substrates) but these kind of layers are interesting in hte way the binary 'bleeps' and 'blops' are simply squares, but create a foggy depth as the 'pulse' radiates out and fades (computer, shifting binary pressures of money) they appear on the rooms surface, but are only really revealed by the anxiety banding which is more human and not of the this space but more esoteric in nature, moving it more towards these things are there, but how much they affect different people varies.

Experimenting a lot with softer water ripples, but when drawing over the captures it really did become clear that less is more, trying to throw to many interactions or visual language in one space would just be confusing.

Creating a drawover was interesting as it showed the core of the interaction really is holding ground with an aproximation of a persons position in the Cave2 - what does that look like? 
...
Generally I can ask AI or online how to achieve a radiance mask which will be the centre 'calmish' grounded substrate of Anxiety Mart, attempting to capture the wear or grime is likely the most comfotable fractals you can look at, but also talk to the passage of time.

Currently unsure of how to pulse this mask.
Pastl substrate material has been created but not finalised however the space itself doesn't need to be detailed or overworked especially when the 'dirty anxiety' or 'stressors' are very noisy in themselves.
