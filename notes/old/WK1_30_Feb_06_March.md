...
Starting to gather different moodboards and ideas. Currently thinking about the role of symbols and iconography - a wrap around experience like the Cave has a nice opportunity to lean into environmental sotry telling a pontentially immerse experience.

---

![alt text](../images/image-2.png)

Interested in the science behind pattern glare and cognitive overload. This was from a past experience on educational projects that attempt to manage 'realism' with learning, howeverever eyestrain is a real issue in these environments. Some cursory research showed an interesting paper
...
Potential project ideas, radio dial that controls the vibe of the experience. Changing the dial lerps between different materials and or geometry to different visual style that evokes more discomfort or 'intensity' approaching it as technical look at why certain lighting, material treatments create a viscerly different experience for the viewer.
...
Anothe idea was detecting a users movement and controlling an abstract SFD in Unreal like a spongy heart. 

More movement or biometrics could cause a speed up or slowdown, effectively driving between morph targets, essentially 'driving' the beating heart. 
...
Shadertoy is a really powerful way to expirement with materials in OpenGL, which ports over well to HLSL (with the help of AI)

This pattern was achieved by creating a test animation of Black and white pulses drawing images and 
...
Media pipe is fascinating, very powerful tool which would be a great way to capture a persons movement or state in an environment with just a video feed.
This definitely feels like the right choice for my project, as kinect had piqued my interest however mediapipe effectly allows me to explore the same concepts.
